	            ...
	            builder.push("Blacklist Options");
			    	...
			    	blacklistedBiomeSurfaces = builder
		                    .comment(" \r\n-----------------------------------------------------\r\n\r\n"
		                    		...
		                    		+" \r\n"
		                    		+" Also, some modded biomes might add Air as a surface which will create surface\r\n"
		                    		+" pits that looks like it is missing the top layer of land. Add minecraft:air to \r\n"
		                    		+" this config to prevent these surfaces from being added.\r\n"
		                    		+" \r\n"
		                    		+" NOTE: You can blacklist multiple things at a time. Just separate\r\n"
