...
//	private double min = 100000;
	...
	{
		double perlinNoise = perlinGen.noiseAt(x * 0.055D, z * 0.055D, false);
		double perlinNoise2 = perlinGen.noiseAt(x * 0.075D + 1000, z * 0.075D + 1000, false);
